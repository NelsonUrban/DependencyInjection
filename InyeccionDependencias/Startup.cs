...
namespace InyeccionDependencias
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services) // clase de configuracion
        {
            services.AddMvc();

            services.AddSingleton<IEmailService, EmailServiceDummy>();  // Agregando IOC Inversion de Control 
            ...
            //Ciclo de Vida del los Objectos
